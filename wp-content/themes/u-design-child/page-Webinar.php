	...
	<div id="main-content" class="full-width">
		<div id="network" class="network-page webinar">
            ...
            <div class="join-box">
                ...
                <br><br>
                <a href="/supportraisingsolutions.org/login/?redirect_to=%2Fsupportraisingsolutions.org%2Fwebinar%2F">Sign In</a><a style="border-left: solid black; border-width: 1px; " href="mailto:info@supportraisingsolutions.org">Join</a>
            </div>
            <div class="clear"></div>
                        ...
                        <div class="event">
                            ...
                            <div class="event-time">
                                ...
                                if (strtotime($webinar_date) <= $todaysDate) {
                                    ...
                                    echo '<button class="blue"><a href="javascript:cal.download(\'Webinar\')" style="color: white; font-size: 12px !important">Add to Cal</a></button>';
                                }
